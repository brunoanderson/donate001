...
import { getCampaign, donate, getActiveCampaigns } from "../services/Web3Service";
...
async function listActiveCampaigns() {
    try {
      ...
      for (let i = 0; i < activeCampaigns.length; i++) {
        console.log("ID da campanha ativa: ", activeCampaigns[i]);
      }
            ...
            <div className="container">
                <h1 className="display-5 fw-bold text-body-emphasis lh-1 mb-3">Donate Crypto</h1>
                {
                    !campaign.id
                        ...
                        : (
                            <>
                                <p>Verifique se esta é a campanha certa antes de finalizar sua doação. As doações devem ser realizadas dentro da rede ACRIA.AI TESTNET</p>
                                <hr />
                                <div className="row flex-lg-row-reverse align-items-center g-5">
                                    ...
                                    <div className="col-5 mb-5" style={{ height: 480, scrollbars: true }}>
                                        ...
                                        <p className="mb-3 fst-italic mt-5">
                                            E aí, o que achou do projeto? Já foi arrecadado {campaign.balance / 10 ** 18} ACRIA nesta campanha. O quanto você quer doar (em ACRIA)?
                                        </p>
                                        <div className="mb-3">
                                            <div className="input-group">
                                                <input type="number" id="donation" className="form-control" onChange={onChangeValue} value={donation} />
                                                <span className="input-group-text">ACRIA</span>
